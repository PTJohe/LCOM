...
static int proc_args(int argc, char *argv[]) {
	...
	if (strncmp(argv[1], "config", strlen("config")) == 0) {
		if (argc != 3) {
			printf(
					"timer_test: wrong no of arguments for test of timer_test_config \n");
			return 1;
		}
		...
		if (argc != 3) {
			printf(
					"timer_test: wrong no of arguments for test of timer_test_square \n");
			return 1;
		}
		...
		if (argc != 3) {
			printf(
					"timer_test: wrong no of arguments for test of timer_test_int \n");
			return 1;
		}
